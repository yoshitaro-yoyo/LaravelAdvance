...
{{-- ＄userが所有しているmovieの情報を取得して、最新の動画情報だけを取得。＄movie���これを代入している --}}
...
{{-- 画面幅ラージ以上、4✕３で１２のグリッドシステムなので一人あたり４の画面幅をとる事にする --}}
...
{{-- ?controls=1で動画上にバー表示 loop=1でどうがの繰返しでplaylist={{ $movie->url }}で動画のURLを指定している。frameborder=0 外枠を消す --}}
